...
class JurusanServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(JurusanService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Jurusan');
    ...
    public function testUpdate()
    {
        ...
        $this->assertDatabaseHas('jurusans', $this->editedArray);
    }
