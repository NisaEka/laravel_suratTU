...
class JenissuratServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(JenissuratService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Jenissurat');
    ...
    public function testUpdate()
    {
        ...
        $this->assertDatabaseHas('jenissurats', $this->editedArray);
    }
