...
class PejabatServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(PejabatService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'enim',
		'jabatan' => 'ut',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Pejabat');
    ...
    public function testUpdate()
    {
        ...
        $this->assertDatabaseHas('pejabats', $this->editedArray);
    }
