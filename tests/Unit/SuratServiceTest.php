...
class SuratServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(SuratService::class);
        $this->originalArray = [
            'id' => '1',
		'mhs_id' => '1',
		'jenissurat' => '1',
		'detail' => 'nulla sint quis et',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Surat');
    ...
    public function testUpdate()
    {
        ...
        $this->assertDatabaseHas('surats', $this->editedArray);
    }
