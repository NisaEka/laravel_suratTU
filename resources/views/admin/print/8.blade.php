...
<body>
	...
	<p> Nomor<span style="margin-left: 21px"></span>: B-252/un.5/III.7/PP.009/{{$surat->id}}/2019</p>
	<p> lampiran<span style="margin-left: 10px"></span>: -</p>
	<p> perihal<span style="margin-left: 18px"></span> : <b>Permohonan Ijin Kerja Praktik</b></p>
	<br>
